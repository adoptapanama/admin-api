...
const statusCodes = {
  ...
  'NOTFOUND_USER_ORGANIZATION_ROLE_NOT_FOUND': 'User not found in organization'
};
...
Object.assign(Errors, {
  ...
  UserOrganizationRoleNotFoundError: factoryErrors('UserOrganizationRoleNotFoundError', 'NOTFOUND_USER_ORGANIZATION_ROLE_NOT_FOUND'),
